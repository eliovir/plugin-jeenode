...
<div class="row row-overflow">
    <div class="col-lg-2">
        <div class="bs-sidebar">
            <ul id="ul_jeenode" class="nav nav-list bs-sidenav">
                <a class="btn btn-default eqLogicAction" style="width : 100%;margin-top : 5px;margin-bottom: 5px;" data-action="add"><i class="fa fa-plus-circle"></i> {{Ajouter un Jeenode}}</a>
                    ...
                    <div class="row">
                        <div class="col-lg-5">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-3">
                                    <input type="text" class="eqRealAttr form-control" data-l1key="configuration" data-l2key="group" placeholder="{{Groupe du jeenode}}" value="212"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3 control-label">{{Radio sync mode}}</label>
                                <div class="col-lg-3">
                                    <input class="form-control" type="text" class="eqRealAttr form-control" data-l1key="configuration" data-l2key="debitSerial" placeholder="{{Mode de syncrhonisation radio}}" value="2"/>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-5">     
                            <div class="form-group">
                                ...
                                <div class="col-lg-3">
                                    <input class="form-control" type="text" class="eqRealAttr form-control" data-l1key="configuration" data-l2key="debitSerial" placeholder="{{Temps d'attente avant relance (ms)}}" value="10"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3 control-label">{{Retry limit}}</label>
                                <div class="col-lg-3">
                                    <input class="form-control" type="text" class="eqRealAttr form-control" data-l1key="configuration" data-l2key="debitSerial" placeholder="{{Nombre d'essai avant abandont}}" value="3"/>
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-lg-3 control-label">{{Ack time}}</label>
                                <div class="col-lg-3">
                                    <input class="form-control" type="text" class="eqRealAttr form-control" data-l1key="configuration" data-l2key="debitSerial" placeholder="{{Temps d'attente avant le ack (ms)}}" value="10"/>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <form class="form-horizontal">
                    <fieldset>
                        <div class="form-group">
                            ...
                            <div class="col-lg-8">
                                <input class="form-control" type="text"  id="in_addJeenodeName" placeholder="{{Nom du jeenode}}"/>
                            </div>
                        </div>
                        <div class="form-group">
